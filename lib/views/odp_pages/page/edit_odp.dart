...
import 'package:sknet_myadmin/views/odp_pages/controller/edit_odp_controller.dart';
...
class EditOdp extends StatefulWidget {
  const EditOdp({
    super.key,
  });

  @override
  State<EditOdp> createState() => _EditOdpState();
}

class _EditOdpState extends State<EditOdp> {
  @override
  void initState() {
    super.initState();
  ...
  final controller = Get.find<EditOdpController>();
                            ...
                            children: [
                                    ...
                                    options: MapOptions(
                                      ...
                                      onTap: (tapPosition, point) {
                                        setState(() {
                                          ...
                                          controller.cLat.text = point.latitude
                              ...
                              SizedBox(
                                ...
                                child: CustomButton(
                                  label: 'Simpan',
                                  action: () {
                                    String? valueId = odp.value.id;
                                    int id = int.parse(valueId!);
